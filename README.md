...
<title>Unban WhatsApp — BAAN</title>
...
<header class="topbar">
  ...
  <div class="title-top">Website Unband By BAAN STORE</div>
</header>
...
<div id="lockModal" role="dialog" aria-modal="true" aria-labelledby="lockTitle">
  <div class="lock-card" id="lockCard" aria-live="polite">
    ...
    <p>Ini Web 100% gacor, oleh karena itu pungguna wajib join grub dan sher link web ini ke teman² kalian terlebih dahulu sebelum memakai web- ini, setelah join dan sher otomatis kunci terbuka✅:</p>
  ...
  <ul>
    <li class="has-submenu">
      ...
      <ul class="submenu" id="contactSubmenu">
        <li><a href="https://wa.me/6283178289982" target="_blank" rel="noopener"><i class="fa-brands fa-whatsapp"></i> WhatsApp</a></li>
        <li><a href="https/t.me/GyzenOfficial" target="_blank" rel="noopener"><i class="fa-brands fa-telegram"></i> Telegram</a></li>
        <li><a href="https:nstagram.com/di" target="_blank" rel="noopener"><i class="fa-brands fa-instagram"></i> Instagram</a></li>
        <li><a href="ht://youtube.com/@GyzenLyoraa-ID" target="_blank" rel="noopener"><i class="fa-brands fa-youtube"></i> YouTube</a></li>
      </ul>
    </li>
    ...
    <li class="has-submenu">
      ...
      <ul class="submenu" id="infoSubmenu">
        <li><a href="https://whatsapp.com/channel/0029Vb6zNBx1HspxKHjwrX1n" target="_blank" rel="noopener"><i class="fa-brands fa-whatsapp"></i> WhatsApp Channel</a></li>
      </ul>
    </li>
    ...
    <li class="has-submenu">
      ...
      <ul class="submenu" id="jasaSubmenu">
        <li><a href="https://wa.me/6283178289982" target="_blank" rel="noopener"><i class="fa-brands fa-whatsapp"></i> WhatsApp</a></li>
        <li><a href="https://t.me/GyzenOffal" target="_blank" rel="noopener"><i class="fa-brands fa-telegram"></i> Telegram</a></li>
        <li><a href="https://t.me/AboutGyzenLy" target="_blank" rel="noopener"><i class="fa-brands fa-telegram"></i> Telegram</a></li>
      </ul>
    </li>
  </ul>
</nav>
...
joinBtn.addEventListener('click', ()=>{
  ...
  window.open("https://whatsapp.com/channel/0029Vb6zNBx1HspxKHjwrX1n", "_blank");
  joined = true;
  updateProgress();
});
...
shareBtn.addEventListener('click', ()=>{
  const siteUrl = "https://whatsapp.com/channel/0029Vb6zNBx1HspxKHjwrX1n";
  const message =
`*Saluran Testimoni BAAN STORE*
> Jangan Lupo Folow Dan Sv Wa Di Bio
Link : ${siteUrl}`;
...
document.getElementById('jasaToggle').addEventListener('click', ()=>{
  ...
  <source src="https://files.catbox.moe/fjyyzv.mp3" type="audio/mpeg">
